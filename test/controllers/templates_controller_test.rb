...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference("Template.count") do
      post templates_url, params: { template: { body: @template.body, subject: @template.subject, title: @template.title } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { body: @template.body, subject: @template.subject, title: @template.title } }
